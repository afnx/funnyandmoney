...
$sql = "SELECT * FROM balance WHERE actionID=7 AND
...
<div class="panel panel-default">
										...
										<div class="panel-heading"
											...
											<h3>Hediye Kayıtları </h3>

											<p style="margin-bottom: 5px;">Hediye olarak yüklenen tüm puanları görebilirsiniz.<p>  
...
var link = "https://www.funnyandmoney.com/admin?tab=giftHistory"; 
...
$("#date1S, #date2S").change(function()
{
    ...
    link = "https://www.funnyandmoney.com/admin?tab=giftHistory&date1=" + date1 + "&date2=" + date2;  
});
