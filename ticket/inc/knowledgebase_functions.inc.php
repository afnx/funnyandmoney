...
function hesk_kbSearchLarge($admin = '')
{
	...
	<div style="text-align:center">
		<form action="<?php echo $action; ?>" method="get" name="searchform">
		<div class="form-group"><span class="largebold"><h3><?php echo $hesklang['ask']; ?></h3></span></div>
		<div class="form-group">
        <input type="text" name="search" class="searchfield" style="width: 50%;" />
		<input type="submit" value="" title="" class="btn btn-primary" style="background: url(img/ico-search.png) no-repeat #4d90fe center; min-width: 45px;" /><br />
		</div>
		</form>
	</div>
