...
<h2 style="margin: 10px;"> <?php echo $hesklang['submit_ticket']; ?> </h2>
...
<!-- START SUBMIT -->
					...
					<div class="col-lg-6 col-md-6 col-sm-6 co-xs-12 margin-bottom-sm-30">
						<div class="panel panel-success">
							...
							<div onclick="location.href='index.php?a=add'" class="panel-body">
								<img src="img/newticket.png" alt="" width="60" height="60" hspace="10"  align="left"  />
								<h3 class="panel-title"><a href="index.php?a=add"><?php echo $hesklang['sub_support']; ?></a></h3>
								<p><?php echo $hesklang['open_ticket']; ?></p>
							</div>
						</div>
					</div>
...
<!-- START VIEW -->
					...
					<div class="col-lg-6 col-md-6 col-sm-6 co-xs-12 margin-bottom-sm-30">
						<div onclick="location.href='ticket.php'" class="panel panel-success">
							
								
						
							<div class="panel-body">
								<img src="img/existingticket.png" alt="" width="60" height="60" hspace="10"  align="left"  />
								<h3 class="panel-title"><a href="ticket.php"><?php echo $hesklang['view_existing']; ?></a></h3>
								<p><?php echo $hesklang['vet']; ?></p>
							</div>
						</div>
					</div>
...
if ($hesk_settings['kb_enable'])
{
	...
	<div class="col-lg-12 col-md-12 col-sm-12 co-xs-12 margin-bottom-sm-30">
